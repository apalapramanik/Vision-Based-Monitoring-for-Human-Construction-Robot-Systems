...
from testrobots.msg import MinMax
...
#  def implies_operator(self):
#         self.spec3a = max(-self.max_val1, self.total_velocity)
#         self.spec3b = max(-self.max_val2, self.total_velocity)
#         self.spec3c = max(-self.max_val3, self.total_velocity)
