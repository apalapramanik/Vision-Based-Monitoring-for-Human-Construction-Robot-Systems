...
class Prediction(object):
    ...
    def __init__(self):
        ...
        rospy.Subscriber("H_Detection_msg",Plot,self.indicator_callback,queue_size=10)  
        rospy.Subscriber("odom", Odometry, self.odom_callback,queue_size=10)
        
        #human1 publishers
        self.human_marker1 = rospy.Publisher("Human_marker_h1", Marker, queue_size=10)
        ...
        #human2 publishers
        self.human_marker2 = rospy.Publisher("Human_marker_h2", Marker, queue_size=10)
        ...
        #human3 publishers
        self.human_marker3 = rospy.Publisher("Human_marker_h3", Marker, queue_size=10)
...
>>>>>>> c9a6cac67ff155255afda8a438b47be92a6705f4
                    ...
                    Human_Marker_cube2.pose.position.x = meanx2 
                    Human_Marker_cube2.pose.position.y = 0.0
                    Human_Marker_cube2.pose.position.z = meanz2 
                    ...
                    pred_array2 = []
                    for pt2 in transform_array2: 
                        
                        predicted2 = kf_cv2.predict(pt2[0], pt2[1]) 
                    ...
                    if math.isnan(pt2[0]):
                        ...
                        for i in range(5):  
                            b = b + 1                  
                            predicted2 = kf_cv2.predict(predicted2[0],predicted2[1])
                ...
                if np.all(np.isnan(x3)) :
                   ...
                   #add positions to array and transform:
                    ...
                    position_msg3.x = meanx3 
                    position_msg3.z = meanz3 
                    ...
                    Human_Marker_cube3.pose.position.x = meanx3 
                    Human_Marker_cube3.pose.position.y = 0.0
                    Human_Marker_cube3.pose.position.z = meanz3 
                    ...
                    pred_array3 = []
                    for pt3 in transform_array3: 
                       
                        predicted3 = kf_cv3.predict(pt3[0], pt3[1]) 
                    ...
                    if math.isnan(pt3[0]):
                        ...
                        for i in range(5):  
                            c = c + 1                  
                            predicted3 = kf_cv3.predict(predicted3[0],predicted3[1])
                        ...
                        pred3_distance_array = []   
                        for z in pred_array3:
                            pred3_distance = ((z[0]**2 + z[1]**2)**0.5)
                            pred3_distance_array.append(pred3_distance)
                            
                        pred3_array_msg.data = pred3_distance_array
                        self.pred3_array.publish(pred3_array_msg)       
