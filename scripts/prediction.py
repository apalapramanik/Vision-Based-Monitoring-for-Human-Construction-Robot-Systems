...
class Prediction(object):
                ...
                if np.all(np.isnan(x2)):
                    ...
                    if len(transform_array2)<10:
                        if len(transform_array2)==0:
                            ...
                            np.savetxt("org2.txt", transform_array2, delimiter=",")
                        else:
    ...
    #             #human 1   
                if np.nanmean(x1) != float(nan):
                    ...
                    for pt in transform_array1: #transform_array1 #range(len(transform_array1))
                ...
                if np.nanmean(x2) != float(nan):
                    ...
                    for pt in transform_array2: #transform_array2
                        if math.isnan(pt[0]):
                            print("No Human 2")
                        else:
                ...
                if np.nanmean(x3) != float(nan):
                    ...
                    for pt in transform_array3: #transform_array3
                        if math.isnan(pt[0]):
                            print("No Human 3")
