...
<<<<<<< HEAD
            distance_from_human1.distance = 1.25
=======
...
<<<<<<< HEAD
            distance_from_human2.distance = 1.25
=======
...
<<<<<<< HEAD
            distance_from_human3.distance = 1.25
=======
...
<<<<<<< HEAD
        orientation = [-0.000186, 0.003528, 2.830742] #-0.001809, 0.002350, 3.101696
        position = {'x': 7.713411, 'y' : -0.097611}  #'x': 7.713411, 'y' : 0.519357
        quaternion = {'r1' : -0.000, 'r2' : 0.000, 'r3' : 0.999, 'r4' : 0.042} #run command : rosrun tf tf_echo /map /base_link -0.000, 0.000, 0.999, 0.042
=======
